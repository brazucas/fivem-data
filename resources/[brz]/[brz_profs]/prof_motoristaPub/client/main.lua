...
function setUpNextStop()
    ...
    Citizen.CreateThread(function()
        local distance = GetDistanceBetweenCoords(playerPosition, nextStop.x, nextStop.y, nextStop.z, true)
        while distance > 250 do
            Citizen.Wait(1000)
            distance = GetDistanceBetweenCoords(playerPosition, nextStop.x, nextStop.y, nextStop.z, true)
        end
