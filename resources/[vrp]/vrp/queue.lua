...
Config.Language = {
	joining = "[ BRZ ] Entrando...",
	connecting = "[ BRZ ] Conectando...",
	err = "[ BRZ ] Não foi possível identificar sua Steam ou Social Club.",
	_err = "[ BRZ ] Você foi desconectado por demorar demais na fila.",
	pos = "[ BRZ ] Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[ BRZ ] Não foi possível adiciona-lo na fila.",
    wlonly = "[ BRZ ] Você não está aprovado na whitelist.",
	banned = "[ BRZ ] Seu passaporte foi revogado na cidade.",
	steam = "[ BRZ  ] Você precisa estar com a Steam aberta para conectar."
}
